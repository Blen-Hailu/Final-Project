...
const SIGNUP_COOKS = `mutation addCooks($activities: String = "", $ad_1_street: String = "", $ad_2_apt: String = "", $ad_3_city: String = "", $ad_4_postcode: String = "", $ad_5_country: String = "", $alcoholpassi: String = "", $bio: String = "", $first_name: String = "", $hygienipassi: String = "", $nick_name: String = "", $phone_number: String = "", $profile_picture: String = "", $service_location: String = "", $signature_dishes: String = "", $signature_dishes_picture: String = "", $sur_name: String = "") {
  insert_zestii_cooks(objects: {activities: $activities, ad_1_street: $ad_1_street, ad_2_apt: $ad_2_apt, ad_3_city: $ad_3_city, ad_4_postcode: $ad_4_postcode, ad_5_country: $ad_5_country, alcoholpassi: $alcoholpassi, bio: $bio, first_name: $first_name, hygienipassi: $hygienipassi, nick_name: $nick_name, phone_number: $phone_number, profile_picture: $profile_picture, service_location: $service_location, signature_dishes: $signature_dishes, signature_dishes_picture: $signature_dishes_picture, sur_name: $sur_name}) {
    returning {
      activities
      nick_name
      id
